...
\subsection{Physical criterion for support choosing}
	...
	Still, we provided a module with functions computing the volume of an object and the position of the center of gravity, as those are not trivial when using a surface-based representation of the objects.
