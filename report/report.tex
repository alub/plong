...
The client team first told us about this Ultimaker 3D printer she recently acquired and on which she had still no control over. Our main goal was\ldots
...
As those algorithms can be very computationnaly heavy, and we have used a interpreted language, those repairs would be unpractical to do in Blender using the API. One would have to do a C module for Blender.
