...
\begin{frame}
	...
	\begin{block}{}
    \begin{itemize}
		\item A web based project management system: Chiliproject (Gantt charts, calendars, documents, Wiki, code deposit, notifications…)
...
\begin{frame}
	...
	\item The G-code Generator: to generate the printer's instructions.
	\item The printer's driver: to send the instructions including special parameters such as the temperature.
